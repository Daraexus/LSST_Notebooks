...
class ImageDifferenceConfig(pexConfig.Config):
    ...
    doWriteWarpedExp = pexConfig.Field(dtype=bool, default=False,
        doc="Write warped template coadd exposure?")
	...
	print("No recasting performed: the default method is %s", self.getTemplate) 
    ...
    def run(self, sensorRef, templateIdList=None):
        ...
        if self.config.doSubtract:
            ...
            if self.config.doUseRegister:
	           ...
	           print("=================================writing warped exp")
		   sensorRef.put(warpedExp, self.config.coaddName + "Diff_warpedExp")
